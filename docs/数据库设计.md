...
(
    ...
    `job_name`        varchar(50) NULL     DEFAULT NULL COMMENT '任务名称',
    `cron_expression` varchar(20) NULL     DEFAULT NULL COMMENT 'cron表达式',
    `db_source`       varchar(500) NULL     DEFAULT NULL COMMENT '源头数据库',
    `db_dest`         varchar(500) NULL     DEFAULT NULL COMMENT '目标数据库',
    `status`          tinyint(1)   NOT NULL DEFAULT 0 COMMENT '状态 0 启动 1 停止',
    `user_id`         bigint(20)    NOT NULL COMMENT '创建人id 关联user',
    `create_time`     timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
